...
install: msi-ml 10-msi.rules init_scripts/keyboard-backlight-disable.service
...
# Installs a daemon to disable the keyboard backlight
	cp init_scripts/keyboard-backlight-disable.service /etc/systemd/system/keyboard-backlight-disable.service
